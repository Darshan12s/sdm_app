...
const AccountFAQScreen: React.FC = () => {
  ...
  const faqData: FAQItem[] = [
    ...
    },
    {
      ...
      answer: 'Yes, you can delete your account by going to Profile > Settings > Account Settings > Delete Account. Please note that account deletion is permanent and cannot be undone. All your data, ride history, and saved addresses will be permanently removed. Contact support if you have active bookings.',
      category: 'account',
    },
    {
      id: 'update-profile',
      question: 'How to update my profile?',
      answer: 'Go to your Profile screen and tap the edit button next to Personal Information. You can update your name, email, phone number, and date of birth. For profile picture, tap on the avatar and choose to take a photo or select from gallery. Changes are saved automatically.',
      category: 'account',
    },
    {
      id: 'forgot-password',
    ...
    },
    {
      ...
      answer: 'Account verification is done automatically when you register. For additional verification (like adding payment methods), you may need to provide additional documents. Go to Profile > Account Verification to check your verification status and complete any pending verifications.',
      category: 'account',
    },
    {
      id: 'privacy-settings',
      question: 'How to manage privacy settings?',
      answer: 'Privacy settings can be managed in Profile > Settings > Privacy. You can control ride visibility, location sharing preferences, and notification settings. You can also manage which information is shared with drivers and other users.',
      category: 'account',
    },
    {
      id: 'account-security',
...
export default AccountFAQScreen;