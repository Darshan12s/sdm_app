...
const PaymentMethodsScreen: React.FC = () => {
  ...
  const fetchPaymentMethods = async () => {
    try {
      ...
      // Try to fetch from customer_payment_methods table
      ...
      if (paymentError) {
        if (paymentError.code === '42P01') {
          console.log('Customer payment methods table does not exist yet');
          ...
          setPaymentMethods([
            {
              ...
              card_number: '**** **** **** 1234',
              card_type: 'Visa',
              account_holder_name: 'John Customer',
              is_primary: true,
              is_verified: true,
  ...
  const handleSetPrimary = (methodId: string) => {
    Alert.alert(
      'Set as Primary',
      'Set this payment method as your primary method for payments?',
      [
        ...
        {paymentMethods.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={[styles.emptyStateSubtext, { color: colors.textSecondary }]}>
              Add a payment method to make ride payments
            </Text>
